...
{   
    ...
    */
    public native JSRange createRange(Text startPoint,
                                      int startOffset,
                                      Text endPoint,
                                      int endOffset)
    /*-{
    ...
    * @return A range end point with a proper text node
    */
	...
	else
	{
	    ...
	    Node child = node.getChild(dir ? offset - 1 : offset);
	    ...
	    res = new RangeEndPoint(text, dir ? 0 : text.getData().length());
	}
	return res;
    }
}
