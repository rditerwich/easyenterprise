...
public interface EEPagingButton {
	...
	public class Previous extends Composite implements EEPagingButton {
		...
		public void render() {
			if (getWidget() instanceof PushButton) {
				PushButton pushButton = (PushButton) getWidget();
				pushButton.setEnabled(!data.isFirstPage());
			}
		}
	}
	
	public class Next extends Composite implements EEPagingButton {
		private final PagedData<?> data;
