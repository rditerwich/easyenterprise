...
INSERT INTO "catalogxs"."property" (name,type_id,id,product_group_id) VALUES ('Color','String', 21,3);
INSERT INTO "catalogxs"."property" (name,type_id,id,product_group_id) VALUES ('Kleur Code','String',22,3);
INSERT INTO "catalogxs"."property" (name,type_id,id,product_group_id) VALUES ('Weight','Integer', 23,3);
INSERT INTO "catalogxs"."property" (name,type_id,id,product_group_id) VALUES ('PackingUnit','Integer', 24,3);
...
/* Promotion examples */
INSERT INTO "catalogxs"."promotion" (type,start_date,end_date,id,product_id,price,price_currency,volume_discount,view_id) VALUES ('agilexs.catalogxs.jpa.catalog.VolumeDiscountPromotion','2010-01-20','2011-01-20',1,1,100,'EUR',3,1);
INSERT INTO "catalogxs"."promotion" (type,start_date,end_date,id,product_id,price,price_currency,volume_discount,view_id) VALUES ('agilexs.catalogxs.jpa.catalog.VolumeDiscountPromotion','2010-01-22','2011-02-20',2,2,700,'EUR',4,1);
INSERT INTO "catalogxs"."promotion" (type,start_date,end_date,id,product_id,price,price_currency,volume_discount,view_id) VALUES ('agilexs.catalogxs.jpa.catalog.VolumeDiscountPromotion','2010-01-10','2011-03-10',3,3,80,'EUR',5,1);
INSERT INTO "catalogxs"."promotion" (type,start_date,end_date,id,product_id,price,price_currency,volume_discount,view_id) VALUES ('agilexs.catalogxs.jpa.catalog.VolumeDiscountPromotion','2009-12-30','2011-04-02',4,4,90,'EUR',6,1);
INSERT INTO "catalogxs"."promotion" (type,start_date,end_date,id,product_id,price,price_currency,volume_discount,view_id) VALUES ('agilexs.catalogxs.jpa.catalog.VolumeDiscountPromotion','2010-01-05','2011-05-05',5,5,110,'EUR',7,1);
