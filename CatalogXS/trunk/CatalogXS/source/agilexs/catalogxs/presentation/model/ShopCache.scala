...
class ShopCache {
  ...
  val shopsByServerName : Map[String, Set[Shop]] = shops groupBy (_.serverName)
...
class ShopCacheData (val catalog : jpa.catalog.Catalog, val shop : jpa.shop.Shop) {
  ...
  val productGroupChildGroups : Map[jpa.catalog.ProductGroup, Set[jpa.catalog.ProductGroup]] = 
    new mutable.HashMap[jpa.catalog.ProductGroup, Set[jpa.catalog.ProductGroup]] useIn 
	  (productGroupChildGroups(catalog.getItems classFilter(classOf[jpa.catalog.ProductGroup]), new mutable.HashSet[jpa.catalog.ProductGroup], _)) readOnly  
    
  val productGroupParents : Map[jpa.catalog.ProductGroup, Set[jpa.catalog.ProductGroup]] = 
    new mutable.HashMap[jpa.catalog.ProductGroup, Set[jpa.catalog.ProductGroup]] useIn 
	  (productGroupParents(catalog.getItems classFilter(classOf[jpa.catalog.ProductGroup]), new mutable.HashSet[jpa.catalog.ProductGroup], _)) readOnly  
  ...
  val products : Set[jpa.catalog.Product] = 
	new mutable.HashSet[jpa.catalog.Product] useIn 
	 (products(shop.getTopLevelProductGroups, new mutable.HashSet[jpa.catalog.ProductGroup], _)) readOnly
  ...
  val productGroupProductExtent : Map[jpa.catalog.ProductGroup, Set[jpa.catalog.Product]] = 
    new mutable.HashMap[jpa.catalog.ProductGroup, Set[jpa.catalog.Product]] useIn 
  ...
  private def productGroupProductExtent(groups : Iterable[jpa.catalog.ProductGroup], result : mutable.Map[jpa.catalog.ProductGroup, Set[jpa.catalog.Product]]) : Set[jpa.catalog.Product] = {
