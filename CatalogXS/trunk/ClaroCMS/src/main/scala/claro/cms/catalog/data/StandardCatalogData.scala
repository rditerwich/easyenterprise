...
object StandardCatalogData extends Dao {
  ...
  def plaat = {
    ...
    CatalogDao.createProduct("AGFA Lithostar Ultra 8mil", "PCG07061", "90-25-19/32X21-21/32 LAPV+ 8MIL", 646.65, getClass, "agfalithostar.jpg", agfa, plates)
    CatalogDao.createProduct("AGFA Lithostar Chemistry", "LXAZW000", "20L-AGFA L5000B ULTRA DEVELOPER", 131.55, getClass, "agfalithostar.jpg", agfa, plates)
    CatalogDao.createProduct("AGFA Lithostar Chemistry", "OETTT000", "20L-AGFA L5000B ULTRA FINISHER", 120.20, getClass, "agfalithostar.jpg", agfa, plates)
    CatalogDao.createProduct("AGFA Lithostar Chemistry", "P9EHY000", "3-LITHOSTAR LAPV CORR PEN BROAD TIP", 45.05, getClass, "agfalithostar.jpg", agfa, plates)
  }
  ...
  def inks = {
	  ...
	  CatalogDao.createProduct("Abdick Multigraphics RB900 black", "83-9-104411", "Abdick RB900 black rubber base CAN", 9.97, getClass, "abdick.jpg", abdick, blackInk)
	  CatalogDao.createProduct("Abdick Multigraphics RB900 black", "83-9-104411", "Abdick RB900 black rubber base 5LB CAN", 48.11, getClass, "abdick.jpg", abdick, blackInk)
	  CatalogDao.createProduct("Abdick Multigraphics RB900 black", "83-9-104411", "Abdick RB900 black rubber base Cartiridge", 9.39, getClass, "abdick.jpg", abdick, blackInk)
